...
function setMyLightGreen(){
  ...
  let setMeToGreen = document.getElementById(lightId)
  setMeToGreen.className = 'light-green'
}
...
function setMyLightClass(event, desiredClass){
  let lightId = this.dataset.lightId;
  let setTheLightClass = document.getElementById(lightId)
  setTheLightClass.className = desiredClass
}
